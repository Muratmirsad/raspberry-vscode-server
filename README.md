...
## ❗️ Uyarı: Ev ağınızı internete açmak oldukça risklidir; sık kullanılan bir port açmaktan kaçınıp, güçlü şifreler kullanmayı (tavsiyem ssh public key oluşturup bunu şifre kullanmanız) ve eğer ssh kullanıyorsanız, şifre ile oturum açmayı kapatıp, sadece private key ile oturum açma yöntemi kullanmanız önemli.
